...
export default function Reference() {
    return (
        <div className='flex relative pb-20 flex-col items-center bg-gradient-to-br from-gray-900 to-cyan-700 w-[100%] h-[100%]'>
            ...
            <p className='text-cyan-400  y-5 text-lg mg:text-2xl w-[90%] min-w-[300px] text-justify'>
            ...
            <p className='text-cyan-400  my-5 text-lg mg:text-2xl w-[90%] min-w-[300px] text-justify '>
